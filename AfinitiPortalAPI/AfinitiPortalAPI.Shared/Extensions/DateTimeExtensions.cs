...
namespace AfinitiPortalAPI.Shared.Extensions
{
    public static class DateTimeExtensions
    {
        public static DateTime ToDateTime(this string s, string format)
        {
            try
            {
                var r = DateTime.ParseExact(s: s, format: format, provider: Thread.CurrentThread.CurrentCulture);
                return r;
            }
        ...
        public static long ToUnixMSTimestamp(this DateTime input)
        {
            return (long)(input.Subtract(new DateTime(1970, 1, 1))).TotalMilliseconds;
        }

        public static DateTime FromUnixTimestamp(this long input)
        {
            return new DateTime(1970, 1, 1).AddSeconds(input);
        }

        public static DateTime FromUnixMSTimestamp(this long input)
        {
            return new DateTime(1970, 1, 1).AddMilliseconds(input);
        }
